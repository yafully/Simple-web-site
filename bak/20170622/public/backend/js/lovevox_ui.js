		...
		var events = this.events = {}, self = this;
			...
			if(this.hover){
				...
				events['mouseover'] = function(event){
					if(!$(this).find(self.options.mBody) || !$(this).siblings(self.options.mBody) && !self.options.makeTip)
					return false;//不在sce内或不与sec并列
					if(!$.fireEvent(self.options.onHover,[this,self])){return false;}
					// console.log($(this));
				...
				events['click'] = function(event){
					...
					$.fireEvent(self.options.onClick,[event.target,this,self]);
				};
